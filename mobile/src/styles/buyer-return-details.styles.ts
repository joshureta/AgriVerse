...
export const styles = StyleSheet.create({
  ...
  decisionBadge: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 },
  decisionBadgeRefunded: { backgroundColor: '#E6F4EA' },
  decisionBadgeDismissed: { backgroundColor: '#FDECEA' },
  decisionBadgeText: { fontSize: 11, fontWeight: '800' },
  decisionFacts: { flexDirection: 'row', flexWrap: 'wrap', gap: 16, marginTop: 14 },
  decisionFactLabel: { fontSize: 10.5, color: TEXT_MUTED, fontWeight: '600' },
  decisionFactValue: { fontSize: 13, fontWeight: '800', color: DARK_GREEN, marginTop: 2 },
