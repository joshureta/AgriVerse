...
export const styles = StyleSheet.create({
  ...
  orderActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: 9, marginTop: 13, paddingTop: 13, borderTopWidth: 1, borderTopColor: CARD_BORDER },
  ...
  actionButtonPrimary: { borderColor: GREEN },
  ...
  actionButtonPrimaryText: { color: GREEN, fontSize: 12, fontWeight: '800' },
