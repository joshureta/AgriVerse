...
import ReturnDetails from './pages/Buyer/ReturnDetails.jsx'
...
function App() {
  ...
  if (path === '/buyer/return-details') {
    return <ProtectedRoute allowedRoles={['buyer']}><ReturnDetails /></ProtectedRoute>
  }
